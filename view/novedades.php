                    ...
                    <div class="col-4 m-5 col-md-9 col-sm-5">
                        <tr>
                            ...
                            <td>
                                ...
                                <button><a  onclick="return eliminar()"href="../view/novedades.php?pkidNovedades=<?=$datos->pkidNovedades ?>" class="btn btn-outline-danger "Danger><i class="bi bi-trash-fill"></i></a></button>
                            </td>
                        </tr>
                    </div>    
                <?php }
